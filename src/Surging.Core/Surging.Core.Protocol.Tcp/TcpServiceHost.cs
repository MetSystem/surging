...
{
    class TcpServiceHost : ServiceHostAbstract
    {
        #region Field
        ...
        public TcpServiceHost(Func<EndPoint, Task<IMessageListener>> messageListenerFactory, IServiceExecutor serviceExecutor) : base(serviceExecutor)
        {
